      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Pricing</h1>
              <p class="mb-0">There are several price schemes that we offer.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row gy-3">
          ...
          <div class="col-xl-3 col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="pricing-item">
              ...
              <ul>
                <li>Basic class</li>
                <li>No digital books</li>
                <li>There are no events</li>
                <li class="na">Certificate</li>
                <li class="na">Work distribution</li>
              </ul>
              <div class="btn-wrap">
